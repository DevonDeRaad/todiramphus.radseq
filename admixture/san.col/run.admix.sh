...
#SBATCH --chdir=/home/d669d153/work/todi.subset.2022/revision.admixture/san.col     # Set working d$
#SBATCH --mem-per-cpu=1gb            # memory requested
#SBATCH --time=200

#use plink to convert vcf directly to bed format:
/home/d669d153/work/plink --vcf /home/d669d153/work/todi.subset.2022/revision.admixture/san.col/todi.san.col.vcf  --double-id --allow-extra-chr --make-bed --out binary_fileset
